...
public class LoginTwoActivity extends AppCompatActivity{
    ...
    private ArrayList<String> pro = new ArrayList<>(Arrays.asList("湖南省", "湖北省", "江西省", "上海市"));
    private ArrayList<String> type = new ArrayList<>(Arrays.asList("文科", "理科"));
    private ArrayList<String> year = new ArrayList<>(Arrays.asList("2025", "2024"));
